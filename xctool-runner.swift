...
while !arguments.isEmpty {
    ...
    case "build":
        ...
        func build() -> Bool {
            return exec(xctoolPath, "-workspace", workspace, "-scheme", scheme, "-sdk", "iphonesimulator", "CONFIGURATION_BUILD_DIR=\(buildPath)", "-derivedDataPath=\(buildPath)", "clean", "build-tests", "-reporter", "pretty") == 0
        }
